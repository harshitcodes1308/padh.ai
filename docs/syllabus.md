...
> English Language and English Literature are treated as separate subjects.

\*\*\*BIOLOGY

1. Basic Biology
   Cell: cell theory, prokaryotic vs eukaryotic cells  
   Structure & functions of plant and animal cells  
   Tissues: plant and animal tissues, structure, location, functions

2. Flowering Plants
   Structure of a bisexual flower  
   Pollination: self & cross (agents, advantages, disadvantages)  
   Fertilisation: double fertilisation, triple fusion  
   Fruit and seed: definition & significance

3. Plant Physiology
   Seeds: dicot & monocot (bean, maize), germination  
   Respiration in plants: aerobic & anaerobic
...
6. Health & Hygiene
   ...
   Health organisations: WHO, Red Cross

7. Waste Generation & Management
   Sources of waste  
   Waste disposal methods

\*\*\*CHEMISTRY

1. Periodic Properties & Variations
   Trends in groups and periods

2. Chemical Bonding
   Electrovalent & covalent bonds
