...
export default function ElegantShapes() {
  return (
    <div style={{ position: "absolute", inset: 0, overflow: "hidden", pointerEvents: "none", zIndex: 0 }} aria-hidden="true">
      <ElegantShape delay={0.3} width={600} height={140} rotate={12} gradient="rgba(45,129,247,0.15)" style={{ left: "-6%", top: "14%" }} />
      ...
      <ElegantShape delay={0.6} width={200} height={60} rotate={20} gradient="rgba(45,129,247,0.12)" style={{ right: "16%", top: "10%" }} />
