                    ...
                    {uploadType === "text" && (
                        <div className="dashboard-card" style={{ padding: "24px" }}>
                            ...
                            <textarea
                                ...
                                placeholder="Paste your CBSE syllabus here...&#10;&#10;Example:&#10;Mathematics&#10;  Chapter 1: Algebra&#10;  Chapter 2: Geometry&#10;..."
                            ...
                            <div className="mt-4 flex justify-end">
                                <button
                                    ...
                                    className="px-6 py-3 rounded-lg bg-primary hover:bg-blue-500 text-white font-semibold transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                    Process with AI ✨
                                </button>
                            </div>
                            ...
                            {selectedFile && (
                                <div className="mt-4 p-4 rounded-lg bg-green-500/10 border border-green-500/30">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <button
                                            onClick={handleUpload}
                                            className="px-6 py-2 rounded-lg bg-primary hover:bg-blue-500 text-white font-semibold transition-all"
                                        >
                                            Upload ✨
                                        </button>
                                    </div>
